...
[분류 기준]
1. 정보기술 (IT): 컴퓨터, 서버, 네트워크 장비, 소프트웨어, 클라우드 서비스, 통신, IT 유지보수, 시스템 개발, IT 인프라 등 정보기술과 관련된 자산이나 비용
2. 정보보호 (Security): 방화벽, IPS/IDS, 백신, 보안 솔루션, 보안 컨설팅, 취약점 점검, 보안 관제, 암호화 장비, 접근제어 등 정보보호와 관련된 자산이나 비용
3. 제외 (Exclude): 사무용품, 가구, 일반 시설, 차량, 복리후생, 기타 IT/보안과 무관한 항목
